...
#4-4. 그리기
    ...
    if drop==False:
        pygame.draw.line(screen,white,gochu,Q,5) 
    if drop==True:
        Q=(L[0],L[1]+I_jujy+k*5)
        B=(L[0]+5,L[1]+11+k*5)
        V=(L[0]-5,L[1]+11+k*5)
        Q=(L[0],L[1]+I_jujy+k*5)
        R=(L[0]+I_leg*math.cos(60*math.pi/180), L[1]-I_arm*math.sin(60*math.pi/180+k*5))
    else:
        Q=(L[0],L[1]+I_jujy)
        B=(L[0]+5,L[1]+11)
        V=(L[0]-5,L[1]+11)
